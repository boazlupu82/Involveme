...
public class QuizTemplateNStatistycsTest extends BaseTest {
	...
	String beforeView;
	String workSpaceName="Boaz technology";
	...
	public void tc_02_template_tets() {
		HomePage hm = new HomePage(driver);
		hm.chooseWrkSpc("Boaz technology");
		hm.chooseTabAndClick("Published ");
		hm.sleep(2000);
		beforeSubmiss=hm.getProjectSubmssn("Boaz Tech Quiz");
		System.out.println(beforeSubmiss);
		beforeView=hm.getProjectViews("Boaz Tech Quiz");
		System.out.println(beforeView);
		hm.clickView("Boaz Tech Quiz");
