...
public class CalcTemplatePage extends BasePage {
	...
	public void setAnswer(String question, int value) {
		ExpectedCondition<Boolean> elementTextContainsString = arg0 -> header.getText()
				.contains("Find out how much additional revenue you could make.");
	...
	public String getFinalCalcMsg() {
		ExpectedCondition<Boolean> elementTextContainsString = arg0 -> finalMsgTxt.getText()
